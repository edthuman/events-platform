...
function FilmSearchResponse({filmDetails, setFilmDetails, setIsSearchRequired} : {filmDetails: FilmPreviewResponse, setFilmDetails: any, setIsSearchRequired: BooleanStateSetter}) {
    ...
    {Object.keys(filmDetails).length > 1 ? (
            <>
                ...
                <button onClick={() => handleIncorrectFilmFound(setFilmDetails)}>No</button>
            </>
    ) : null}
</>
}
